        ...
        <div className="w-full max-w-100 mx-auto mt-24">
            ...
            {isSuccess ? (
                <Text className="kb-content-tertiary mt-2">
                    We received your request to reset your email. If an account
                ...
                <Text className="kb-content-tertiary mt-2">
                    Enter your email address. If an account exists, you{"'"}ll
                    receive an email with a password reset link soon.
                </Text>
            )}
