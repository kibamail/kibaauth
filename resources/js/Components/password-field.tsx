import { CheckCircleIcon } from "@/icons/check-circle.svg.jsx";
import { EyeClosedIcon } from "@/icons/eye-closed.svg.jsx";
import { EyeIcon } from "@/icons/eye.svg.jsx";
import { XMarkCircleIcon } from "@/icons/x-mark-circle.svg.jsx";
import { usePasswordStrengthIndicator } from "@/hooks/use-password-strength-indicator.js";
...
>((props, forwardedRef) => {
    ...
    const Label = allChildren.find(
        (child) =>
            React.isValidElement(child) && child.type === TextField.Label,
    );

    const hasError = allChildren.some(
        (child) =>
            React.isValidElement(child) && child.type === TextField.Error,
    );
        ...
        <>
            ...
            >
                ...
                <TextField.Slot side="right">
                    <button
                        type="button"
                        className="kb-reset focus:outline-none focus-visible:outline-1 focus-visible:outline-(--border-focus) rounded-sm"
